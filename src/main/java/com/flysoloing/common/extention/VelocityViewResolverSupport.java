...
public class VelocityViewResolverSupport extends WebApplicationObjectSupport {
    ...
    public static final String DEFAULT_REQUEST_CONTEXT_ATTRIBUTE_NAME = "rc";
    ...
    private String requestContextAttribute = DEFAULT_REQUEST_CONTEXT_ATTRIBUTE_NAME;
    ...
    public static final String DEFAULT_DATE_TOOL_ATTRIBUTE_NAME = "dateTool";

    public static final String DEFAULT_NUMBER_TOOL_ATTRIBUTE_NAME ="numberTool";

    private String dateToolAttribute = DEFAULT_DATE_TOOL_ATTRIBUTE_NAME;

    private String numberToolAttribute = DEFAULT_NUMBER_TOOL_ATTRIBUTE_NAME;
    ...
    /**
     * 支持在后台渲染指定模板并返回渲染页面字符串
     *
     * @param velocityConfigurerName velocity配置器名称
    ...
    public String render(String velocityConfigurerName, String templateName, Map<String, Object> model, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        Template template = velocityEngine.getTemplate(templateName + DEFAULT_SUFFIX);
        ...
        try {
            ...
            throw new NestedServletException("Could not render the velocity template '" + templateName + "'", e);
        }
    }
    ...
    private RequestContext createRequestContext(HttpServletRequest request, HttpServletResponse response, Map<String, Object> model) {
    ...
    private String renderMergedOutputModel(Map<String, Object> model, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        return renderMergedTemplateModel(model, request);
    }

    private String renderMergedTemplateModel(Map<String, Object> model, HttpServletRequest request) throws Exception {
        ...
        return doRender(velocityContext);
    }
    ...
    private String doRender(Context context) throws Exception {
        return mergeTemplate(getTemplate(), context);
    }

    private String mergeTemplate(Template template, Context context) throws Exception {
        try {
